...
for image in ${images[@]}; do
    ...
    outdir=../results/simu-oasis3_lr-${lr}_bs-${bs}_ne-${ne}_ns-${ns}_ie-${ie}_sw-${sw_str}_wd-${wd}_ps-${ps}_lrdk-${lrdk_str}_lrdc-${lrdc_str}_no-zp/${kernel}_${fwhm}_${scale}_${len}
    ...
    echo docker run --gpus device=1 --rm \
        ...
        -lrdc ${lrdc[@]} -wd ${wd} -ps ${ps} -ns ${ns} -ie ${ie}
done | rush -j 3 {}
