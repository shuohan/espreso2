...
prefixes=(/data/oasis3/data/sub-OAS30016_ses-d0021_acq-mprage_T1w.nii.gz
          /data/oasis3/data/sub-OAS30032_ses-d3499_acq-mprage_T1w.nii.gz
          /data/oasis3/data/sub-OAS30048_ses-d3367_acq-mprage_T1w.nii.gz
          /data/oasis3/data/sub-OAS30064_ses-d0687_acq-mprage_run-02_T1w.nii.gz
          /data/oasis3/data/sub-OAS30080_ses-d0048_acq-mprage_T1w.nii.gz)
          # /data/oasis3/measure_simu/sub-OAS30096_ses-d0024_acq-mprage_run-01_T1w.nii.gz
          # /data/oasis3/measure_simu/sub-OAS30112_ses-d0259_acq-mprage_T1w.nii.gz
          # /data/oasis3/measure_simu/sub-OAS30127_ses-d0098_acq-mprage_T1w.nii.gz
          # /data/oasis3/measure_simu/sub-OAS30143_ses-d2235_acq-mprage_run-01_T1w.nii.gz
          # /data/oasis3/measure_simu/sub-OAS30160_ses-d0751_acq-mprage_run-01_T1w.nii.gz)

output_dir=/data/spest/ipmi_measure_simu

for prefix in ${prefixes[@]}; do
    suboutdir=$output_dir/$(basename ${prefix} | sed "s/\.nii\.gz//")/truth
