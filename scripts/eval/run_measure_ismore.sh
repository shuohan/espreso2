...
# prefixes=(/data/spest/ismore_without_sp/sub-OAS30016_ses-d0021_acq-mprage_T1w
#           /data/spest/ismore_without_sp/sub-OAS30032_ses-d3499_acq-mprage_T1w
#           /data/spest/ismore_without_sp/sub-OAS30048_ses-d3367_acq-mprage_T1w
#           /data/spest/ismore_without_sp/sub-OAS30064_ses-d0687_acq-mprage_run-02_T1w
#           /data/spest/ismore_without_sp/sub-OAS30080_ses-d0048_acq-mprage_T1w)
prefixes=(/data/spest/ismore_without_sp/sub-OAS30064_ses-d0687_acq-mprage_run-02_T1w)
...
# simu_types=(type-gauss_fwhm-2p0_scale-0p5_len-13)
simu_types=(type-gauss_fwhm-4p0_scale-0p25_len-13)

output_dir=/data/spest/ipmi_esitmate_smore_resolution
...
for prefix in ${prefixes[@]}; do
    for simu_type in ${simu_types[@]}; do
        ...
        image=${prefix}_${simu_type}/output_image.nii
