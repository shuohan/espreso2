...
for image in ${images[@]}; do
    ...
    outdir=../results/simu-brainweb_lr-${lr}_bs-${bs}_ne-${ne}_ie-${ie}_sw-${sw_str}_wd-${wd}_ps-${ps}_lrdk-${lrdk_str}_lrdc-${lrdc_str}_orth/${kernel}_${fwhm}_${scale}_${len}
    ...
    docker run --gpus device=0 --rm \
        ...
        ./train.py -d -i $image -o $outdir -k $kernel -kl 21 -sw ${sw} \
